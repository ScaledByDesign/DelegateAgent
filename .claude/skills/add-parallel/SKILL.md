...
3. Create a polling scheduled task using `mcp__delegateagent__schedule_task`:
   ```
   ...
   3. Send results to user with mcp__delegateagent__send_message
   4. Use mcp__delegateagent__complete_scheduled_task to mark this task as done
